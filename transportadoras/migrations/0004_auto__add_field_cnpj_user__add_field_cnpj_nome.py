...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cnpj.user'
        db.add_column(u'transportadoras_cnpj', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cnpj.nome'
        db.add_column(u'transportadoras_cnpj', 'nome',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cnpj.user'
        db.delete_column(u'transportadoras_cnpj', 'user_id')

        # Deleting field 'Cnpj.nome'
        db.delete_column(u'transportadoras_cnpj', 'nome')
    ...
    models = {
        ...
        u'transportadoras.cnpj': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True'}),
