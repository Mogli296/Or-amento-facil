...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cadastros_service', (
            ...
            ('hourprice', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
            ('tipo', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'cadastros', ['Service'])

        # Adding field 'ProductShip.user'
        db.add_column(u'cadastros_productship', 'user',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'cadastros_service')

        # Deleting field 'ProductShip.user'
        db.delete_column(u'cadastros_productship', 'user_id')
