...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cadastros_payment', (
            ...
            ('productDiscount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
            ('productInstallments', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=2)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastros.Service'], null=True, blank=True)),
            ('serviceDiscount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
            ('serviceInstallments', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=0)),
        ))
        db.send_create_signal(u'cadastros', ['Payment'])


    def backwards(self, orm):
        # Deleting model 'Payment'
        db.delete_table(u'cadastros_payment')
    ...
    models = {
        ...
        u'cadastros.payment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cadastros.Produto']", 'null': 'True', 'blank': 'True'}),
            'productDiscount': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'productInstallments': ('django.db.models.fields.DecimalField', [], {'max_digits': '2', 'decimal_places': '2'}),
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cadastros.Service']", 'null': 'True', 'blank': 'True'}),
            'serviceDiscount': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'serviceInstallments': ('django.db.models.fields.DecimalField', [], {'max_digits': '2', 'decimal_places': '0'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        u'cadastros.person': {
